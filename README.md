...
- **Seasons** live in `src/game/catalog.ts` (`SHIPPED_SEASON`). Porch Year, Night Circuit, and County Circuit are live: culverts, brown widows, ditch wolves, jumpers, feed stores, fair pavilions, new gear, and new crews open by rank.
